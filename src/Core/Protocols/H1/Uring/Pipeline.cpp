...
void Pipeline::H1::queueTlsConnecting(::H1::Gen::H1Connection &conn)
{
...
void Pipeline::H1::queueReadClient(::H1::Gen::H1Connection &conn)
{
    if (conn.isReadingClient)
        return;
...
void Pipeline::H1::queueConnectOrigin(::H1::Gen::H1Connection &originConn)
{
    struct io_uring_sqe *sqe = Utils::Uring::getSqe(ring);
    if (!sqe)
        return;
...
void Pipeline::H1::queueWriteOrigin(::H1::Gen::H1Connection &conn)
{
...
void Pipeline::H1::queueReadOrigin(::H1::Gen::H1Connection &conn)
{
...
void Pipeline::H1::queueWriteClient(::H1::Gen::H1Connection &conn)
{
...
void Pipeline::H1::queueConnectResolver(::H1::Gen::H1Connection &conn, char *ip)
{
...
void Pipeline::H1::queueWriteResolver(::H1::Gen::H1Connection &conn)
{
    io_uring_sqe *sqe = Utils::Uring::getSqe(ring);
    if (!sqe)
        return;
...
void Pipeline::H1::queueReadResolver(::H1::Gen::H1Connection &conn)
{
    io_uring_sqe *sqe = Utils::Uring::getSqe(ring);
    if (!sqe)
        return;
...
void Pipeline::H1::writePage(::H1::Gen::H1Connection &conn, std::string p)
{
